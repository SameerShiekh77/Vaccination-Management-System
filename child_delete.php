...
<body>
    ...
    echo "Welcome ". $_SESSION["username"];}?></h6>
        ...
        <div class="content">
            ...
            $id = $_GET['id'];
            $sql = "DELETE FROM `child_details` WHERE `child_details`.`child_id` = $id";
            $result = mysqli_query($conn, $sql);
            if ($result) {
                echo '
                <div class="alert alert-success alert-dismissible fade show" role="alert">
  <strong>Successfully Deleted</strong> Child Record has deleted
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
</div>
<a href="child.php" type="button" class="btn btn-outline-danger text-center d-flex justify-content-center" >Go Back</a>
