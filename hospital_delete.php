...
<?php
    ...
    $id = $_GET['id'];
    $sql = "DELETE FROM `hopital_list` WHERE `hopital_list`.`hospital_id` = $id";
...
<a href="hospital.php" type="button" class="btn btn-outline-danger text-center d-flex justify-content-center" >Go Back</a>
