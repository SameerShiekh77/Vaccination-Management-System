...
<head>
    <meta charset="utf-8">
    <title>VMS - | Create an Account</title>
    ...
    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <form action="" method='POST'>
                            <div class="form-floating mb-3">
                                <input required type="text" name="username" class="form-control" id="floatingText" placeholder="jhondoe">
                            ...
                            <button type="submit" class="btn btn-primary py-3 w-100 mb-4">Registered</button>
                            <p class="text-center mb-0">Already have an Account? <a href="signin.php"> Log In</a></p>
                        </form>
                    </div>
                </div>
            </div>
